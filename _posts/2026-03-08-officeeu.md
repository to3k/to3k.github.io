...
tags: 
  ...
  - "mailbox-org"
  - "proton-drive"
image: "/images/officeeu.png"
---

[🇵🇱->🇬🇧 Go to english version of this post / Przejdź do angielskiej wersji tego wpisu](https://blog.tomaszdunia.pl/officeeu-eng/)
...
- [**Infomaniak kDrive**](https://www.infomaniak.com/pl/kdrive) – Szwajcarski lider posiadający własne, ekologiczne centra danych. Potężna i stabilna usługa z dyskiem, mailem i dokumentami.

- [**Mailbox.org**](https://mailbox.org/) – Ceniony niemiecki dostawca. Zapewniają legendarnie bezpieczną pocztę oraz chmurowy pakiet biurowy (oparty na Open-Xchange).

- [**Proton Drive**](https://proton.me/drive) – Szwajcarska firma (twórcy ProtonMail), która oferuje usługi z pełnym szyfrowaniem end-to-end (E2EE).