...
[🇵🇱->🇬🇧 Go to english version of this post / Przejdź do angielskiej wersji tego wpisu](https://blog.tomaszdunia.pl/zdradzilem-teamapple-eng/)
...
3. najlepiej dopasowany wynik (jeden!) wyszukiwania, który nie zawsze jest tym czego szukam

5. sponsorowane

7. wydarzenia ograniczone czasowo, czyli jeszcze bardziej ponaglające Cię sponsorowane

9. więcej wyników, w których może być to czego szukam o ile wyszukiwarka w punkcie 2. wyżej nie pokazała mi tego czego potrzebowałem
