---
layout: post
title: "Stremio – tani sposób na VOD"
published: true
categories: 
  - "filmy-i-seriale"
  - "poradniki"
...
[🇵🇱->🇬🇧 Go to english version of this post / Przejdź do angielskiej wersji tego wpisu](https://blog.tomaszdunia.pl/stremio-eng/)
...
W pierwotnej wersji tego wpisu zapomniałem o tym napisać, więc teraz go edytuję, że **z poziomu aplikacji na telewizory nie można edytować dodatków**. Po wejściu w zakładkę Dodatki na telewizorze zobaczymy tylko duży przycisk do wywołania synchronizacji dodatków, które wcześniej zainstalowaliśmy i skonfigurowaliśmy z poziomu przeglądarki lub apliakcji na laptopie lub telefonie/tablecie.
