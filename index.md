...
<div style="margin-bottom: 30px;">
  <input type="text" id="search-input" placeholder="🔍 Szukaj / Search" style="width: 100%; padding: 8px; font-family: monospace; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;">
